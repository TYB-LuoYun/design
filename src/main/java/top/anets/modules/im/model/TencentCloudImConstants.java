...
public class TencentCloudImConstants {
    ...
    /**消息图片类型*/
    public static final String MESSAGE_IMAGE_TYPE = "TIMImageElem";
    /**消息音频类型*/
    public static final String MESSAGE_SOUND_TYPE = "TIMSoundElem";
    /**消息文本类型*/
    public static final String MESSAGE_TEXT_TYPE = "TIMTextElem";
    /**消息视频类型*/
    public static final String MESSAGE_VIDEO_TYPE = "TIMVideoFileElem";
