package top.anets.modules.verify1;
...
//      调用方调用
            ...
            HttpClientUtil.doPost("http://127.0.0.1:2398/verify/testMD5withAES", JSON.toJSONString(request), "utf-8");
        }
    }
